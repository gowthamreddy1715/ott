...
import styles from './ChildPlan1.module.css';
      ...
      <div className={styles.cardsContainer}>
        ...
        <div className={styles.planCard}>
          ...
          <div className={styles.planDetails}>
            ...
            <br />
            <Link to={{ pathname: "/ChildPayment/899", state: { planAmount: 899 } }} className={styles.subscribeButton}>
              Proceed to Payment
            </Link>
          </div>
        </div>

...
const NotificationCard = ({ notification }) => {
  ...
  return (
    <Link to={`/ChildMovie/${notification.id}`} key={notification.id}>
...
const ProfileDropdown = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      // Call the decrement-device-count endpoint
      await axios.post("http://localhost:8800/decrement-device-count", { userId });
        ...
        <nav className="nav-navbar">
          ...
          <div className="nav-container">
            <ul className="nav-nav-list">
              <li className="nav-nav-item"><Link to="/ChildHome">Home</Link></li>
              <li className="nav-nav-item"><Link to="/ChildMovies">Movies</Link></li>
              <li className="nav-nav-item"><Link to="/ChildWatchlist">Watchlist</Link></li>
            </ul>
          </div>
          ...
          <div className="nav-align-right">
            <ul className="nav-nav-list">
              <li className="nav-nav-item">
                <Link to="/ChildSearch" className="nav-search-icon">
